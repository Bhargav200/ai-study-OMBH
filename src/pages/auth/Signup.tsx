      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="space-y-3 pt-2">
            {["AI-powered tutoring on any subject", "Personalized quizzes & progress tracking", "Compete with friends on leaderboards"].map((t) => (
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-background">
        <div className="w-full max-w-md space-y-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-2 text-sm">Start learning smarter in under a minute</p>
          </div>

          <Button variant="outline" className="w-full h-11 gap-3 text-sm font-medium border-border" disabled>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input placeholder="John Doe" value={name} onChange={(e) => setName(e.target.value)} className="pl-10 h-11" required />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input placeholder="you@example.com" type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="pl-10 h-11" required />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input placeholder="••••••••" type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 h-11" required />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                <Input placeholder="••••••••" type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} className="pl-10 h-11" required />
              </div>
            </div>
